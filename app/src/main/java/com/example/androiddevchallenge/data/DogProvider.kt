...
//			description = """
//				|Meet Commander!
//				|Commander is such a sweet boy! Commander weighs approximately 93lbs, but he would benefit from slimming down a few pounds to a healthier weight.
//				|If you are interested in meeting him, please fill out an adoption application found on our website at barcs.org. Applicants are contacted in the order of which they are received.
//			""".trimIndent(),
//			location = "Baltimore, MD",
//		),
		...
		Dog(
			...
			sex = DogSex.Female,
			description = """
				|Cardi is a high energy pup. She has shown to be reactive to other animals, and needs to be an only pet. Cardi (F) 4.5 month old Husky/Pit Bull terrier mix.
			""".trimIndent(),
			images = listOf(
				R.drawable.cardi,
				R.drawable.cardi2,
		...
		Dog(
			...
			sex = DogSex.Female,
			description = """
				|"Meet Love Bug! Love Bug is a very sweet and affectionate mastiff mix. To be precise, LB's DNA test revealed that she's 75% Boerboel, 12.5% standard Bulldog and 12.5% Bullmastiff!
		...
		Dog(
			...
			description = """
			|When we asked the shelter staff if there were any standouts, Blanca was immediately mentioned. She has the sweetest disposition and at 5 years old, she still has enough energy to keep up for a good walk or hike, but has long outgrown the puppy energy. Her foster reported that she crushed her first run so she could definitely help you stay accountable to your New Years resolutions!
